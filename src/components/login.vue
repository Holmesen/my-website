    ...
    <div id="login">
        <div id="log_in" style="height:auto;">
            ...
            <table>
                ...
                <tr>
                    <td></td>
                    <td><input type="submit" value="log in" class="btn"></td>
                    <td></td>
                </tr>
            </table>
        ...
        <!-- <div id="sign_up" style="height:auto;">
            ...
            <table>
                ...
                <tr>
                    <td></td>
                    <td><input type="submit" value="sign up" class="btn"></td>
                    <td></td>
                </tr>
            </table>
...
#log_in>table,#sign_up>table{
    border: none;
    width: auto;
    height: auto;
    margin: auto;
}
#log_in>table>tr,#sign_up>table>tr{
    width: auto;
    height: auto;
    padding: 18px;
    display: flex;
}
#log_in>table td,#sign_up>table td{
    width: 300px;
    height: auto;
    align-content: center;
    display: flex;
